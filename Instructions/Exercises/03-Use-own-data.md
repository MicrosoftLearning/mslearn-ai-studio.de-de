...
1. Wählen Sie im Bereich **Assistenteneinrichtung** **Daten hinzufügen** aus und fügen Sie dann eine Datenquelle mit den folgenden Einstellungen hinzu:
    ...
    - **Datenquelle**:
        ...
        - **Verwenden der benutzerdefinierten Feldzuordnung**: Ausgewählt
        - Aktivieren Sie das Kontrollkästchen, um die entstandene Nutzung zu bestätigen.
    - **Datenfeldzuordnung**:
        - **Inhaltsdaten**: Inhalt
        - **Dateiname**: Filepath
        - **Titel**: Titel
...
1. Wählen Sie den Ordner **brochures-index** aus, der den zuvor erstellten Index enthält.
1. Kopieren Sie im Abschnitt **Datenlinks** für Ihren Index den **Datenverbindungs-URI-Wert** in die Zwischenablage (er sollte etwa wie `azureml://subscriptions/xxx/resourcegroups/xxx/workspaces/xxx/datastores/workspaceblobstore/paths/azureml/xxx/index/` aussehen). Sie benötigen diesen URI, um eine Verbindung mit Ihrem Index im Prompt Flow herzustellen.
...
1. Wählen Sie in der Liste **Runtime** **Start** aus, um die automatische Runtime zu starten.
    ...
    Warten Sie dann, bis sie gestartet wird. Dies stellt einen Berechnungskontext für den Prompt Flow bereit. Während Sie warten, überprüfen Sie auf der Registerkarte **Flow** die Abschnitte für die Tools im Flow.
...
1. Legen Sie im Abschnitt **Lookup** die folgenden Parameterwerte fest:
    ...
    - **mlindex_content**: *Wählen Sie das leere Feld aus, um den Bereich „Generieren“ zu öffnen*
        ...
        - **mlindex_path**: *Einfügen des URI für den Vektorindex*
